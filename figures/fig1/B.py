...
def plot_fig1B(mouse, yyyymmdd, param):
    ...
    metadata_df = data_loader.load_processed_data(outputDir = Config.root, 
    ...
    savepath = os.path.join(FigConfig.paths['savefig_folder'], f'forceplate_raw_weight_v_time_{mouse}_rl{rl}.svg')
...
if __name__=="__main__":
    ...
    yyyymmdd = '2021-10-26'
    param = 'headHW'
    plot_fig1B(mouse, yyyymmdd, param)