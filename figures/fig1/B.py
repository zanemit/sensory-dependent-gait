...
ax.text(0.6,177, f"head height {p_text}", ha = 'center', color = FigConfig.colour_config['headbars'])

plt.tight_layout(w_pad = 0, pad = 0, h_pad = 0)
fig.savefig(Path(FigConfig.paths['savefig_folder']) / f"{yyyymmdd}_snoutBodyAngles_vs_headHW.svg")
