...
def plot_fig2E(phase_bounds, yyyymmdd):
    ...
    savepath = Path(FigConfig.paths['savefig_folder']) / "passiveOptoTreadmill_hindlimbPhase_heatmap.svg"
...
if __name__=="__main__":
    ...
    yyyymmdd = '2022-08-18'
    plot_fig2E(phase_bounds, yyyymmdd)