...
def plot_figS6A(yyyymmdd, indep_var, dep_var, group_num=5):
    ...
    savepath= Path(FigConfig.paths['savefig_folder']) / "forceplate_snoutBodyAngles_vs_headHW_COMPARISON.svg"
...
if __name__=="__main__":    
     ...
     yyyymmdd = '2022-08-18'   
     plot_figS6A(yyyymmdd, indep_var, dep_var)