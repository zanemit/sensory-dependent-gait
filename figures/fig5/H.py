...
def plot_fig5H():
    ...
    p_text = 'n.s.' if stat_dict[cat_coef_str]=='n.s.' and stat_dict['pred2:pred4slope']=='n.s.' else '*'
    ax.text(xlim[0] + (0.53 * (xlim[1]-xlim[0])),
            ylim[1] - (0.18* (ylim[1]-ylim[0])),
            p_text,
    ...
    figtitle = "mtTreadmill_combined_trialType_SBA.svg"
