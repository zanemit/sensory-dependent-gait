...
def plot_fig5A(yyyymmdd, param, dataToPlot, limbRef, appdx,
    ...
    savepath =Path(FigConfig.paths['savefig_folder']) / f"thesis_{yyyymmdd}_mtTreadmill_AVERAGED_POLAR_{param}{group_num}_ALL_{limbRef}.svg"
...
if __name__=="__main__":
    ...
    plot_fig5A(yyyymmdd, param, dataToPlot, limbRef, appdx, data_split)      