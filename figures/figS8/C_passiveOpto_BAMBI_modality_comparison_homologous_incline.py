...
fig.text(0.13, 0.98, "[-40,-20] deg", fontsize=5, color=FigConfig.colour_config['homologous'][0])
fig.text(0.59, 0.98, "[20,40] deg", fontsize=5, color=FigConfig.colour_config['homologous'][4])
