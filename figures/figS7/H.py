...
def plot_figS7H(yyyymmdd, limb, dependent_col, ref, rH_category, rH_categ_str):
    ...
    ax.set_title('L-R synchrony', fontsize=6)
    plt.tight_layout()
...
if __name__=="__main__":
    ...
    limb = 'lF0'  
    plot_figS7H(yyyymmdd, limb, dependent_col, ref, rH_category, rH_categ_str)     