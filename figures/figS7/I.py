...
def plot_figS7I(yyyymmdd, limb, dependent_col, ref, rH_category, rH_categ_str):
    ...
    ax.set_title('L-R asymmetry', fontsize=6)
    plt.tight_layout()
...
if __name__=="__main__":
    ref = 'lH1'
    yyyymmdd = '2022-08-18'
    rH_category = ["Llead", "Rlead"] #"sync" #"alt"
    rH_categ_str = 'asym'
    appdx = f"_rH{rH_categ_str}"
    dependent_col = 'limbSupportPC3'
    limb = 'lF0'   
    plot_figS7I(yyyymmdd, limb, dependent_col, ref, rH_category, rH_categ_str)    