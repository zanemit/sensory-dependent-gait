...
def plot_figS1G(yyyymmdd, param):
    ...
    savepath = os.path.join(FigConfig.paths['savefig_folder'], f'forceplate_foreHeadWeights_{param}_{limb_str}.svg')
