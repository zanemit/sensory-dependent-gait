...
def plot_figS4F(pred, limb, reflimb, yyyymmdds, bounds1, bounds2):
    lower_bound1, upper_bound1 = bounds1
    lower_bound2, upper_bound2 = bounds2
    yyyymmdd1, yyyymmdd2 = yyyymmdds
    
    dir = Config.paths['passiveOpto_output_folder']
    ...
    fig.text(0.13, 0.98, "[-40,-20] deg", fontsize=5, color=FigConfig.colour_config['homolateral'][0])
    fig.text(0.59, 0.98, "[20,40] deg", fontsize=5, color=FigConfig.colour_config['homolateral'][3])
...
if __name__=="__main__":
    ...
    reflimb = 'lH1'
    pred  ='incline'
    plot_figS4F(pred, limb, reflimb, 
                yyyymmdds=['2022-08-18', None],
                bounds1=[-41,-19], 
                bounds2=[19,41]
                )