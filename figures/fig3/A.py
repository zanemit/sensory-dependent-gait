...
def plot_fig3A(yyyymmdd, param, dataToPlot, limbRef, appdx,
               data_split, yyyymmdd2=None, group_num=3, plot_num=2,
    ...
    savepath = Path(FigConfig.paths['savefig_folder']) / f"thesis_{yyyymmdd}_allPhaseHistogramsAVERAGED_POLAR_{param}{group_num}_ALL_{limbRef}_combinedTrials.svg"
...
if __name__=="__main__":
    ...
    plot_fig3A(yyyymmdd, param, dataToPlot, limbRef, 
               appdx, data_split, yyyymmdd2=yyyymmdd2)
