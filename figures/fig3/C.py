...
def plot_fig3C(yyyymmdd, param, dataToPlot, limbRef, appdx,
               group_num=3, plot_num=2):
    ...
    mouselist = np.asarray(['FAA1034836', 'FAA1034840', 'FAA1034842',
                      'FAA1034867', 'FAA1034868',  'FAA1034942',
                      'FAA1034944', 'FAA1034945', 'FAA1034949'])
    ...
    savepath =Path(FigConfig.paths['savefig_folder']) / f"incline_allPhaseHistogramsAVERAGED_POLAR_{param}{group_num}_{dataToPlot}_{limbRef}{appdx}.svg"
...
if __name__=="__main__":
    ...
    limbRef = 'lH1'
    appdx = '_incline'
    plot_fig3C(yyyymmdd, param, dataToPlot, limbRef, appdx)         
