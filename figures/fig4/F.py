...
def plot_fig4F(yyyymmdd, outcome_variable, ref, rH_category,
...
if __name__=="__main__":
    outcome_variable = 'limbSupportPC2' # should change
    ref = 'lH1'
    yyyymmdd = '2022-08-18'
    rH_category ="sync" 
    plot_fig4F(yyyymmdd, outcome_variable, ref, rH_category)