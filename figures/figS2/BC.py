...
import os
from processing import  utils_processing, treadmill_data_manager
from processing.data_config import Config
from figures.fig_config import Config as FigConfig

def plot_figS2BC():
    # PLOT DLC TRACKING PASSIVE OPTO
    inpath = os.path.join(Config.paths['passiveOpto_output_folder'], "ZM_220302_FAA1034836_50Hz_8ms_rl0_analog.bin")
    inpath2 = os.path.join(Config.paths['passiveOpto_output_folder'], "ZM_220302_FAA1034836_50Hz_8ms_rl0_videoLDLC_resnet101_PassiveOptoTreadmill2-LSep9shuffle10_650000.h5")
    inpath3 = os.path.join(Config.paths['passiveOpto_output_folder'], "ZM_220302_FAA1034836_50Hz_8ms_rl0_videoRDLC_resnet101_PassiveOptoTreadmill2-ROct5shuffle10_650000.h5")
    ...
    savepath1 = os.path.join(FigConfig.paths['savefig_folder'], 'passive_treadmill_crosscorr_example_trace.svg')
    fig1.savefig(savepath1, 
                dpi =300,
                transparent = True)
    print(f"FIGURE SAVED AT {savepath1}")
    ...
    # save fig
    os.makedirs(FigConfig.paths['savefig_folder'], exist_ok=True)
    savepath2 = os.path.join(FigConfig.paths['savefig_folder'], 'passive_treadmill_crosscorr_example.svg')
    fig2.savefig(savepath2, 
                dpi =300,
                transparent = True)
    print(f"FIGURE SAVED AT {savepath2}")
