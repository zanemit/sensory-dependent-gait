...
def plot_figS2E(yyyymmdd, phase_bounds):
    ...
    savepath = Path(FigConfig.paths['savefig_folder']) / f"mtTreadmill_hindlimbPhase_heatmap.svg"
...
if __name__=="__main__":
    ...
    yyyymmdd = '2021-10-23'
    plot_figS2E(yyyymmdd, phase_bounds)