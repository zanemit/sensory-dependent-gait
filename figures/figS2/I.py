...
fig, ax = plt.subplots(2,3,figsize = (1.45*3,1.5), gridspec_kw = {'height_ratios': [9,1], 'width_ratios': [15,15,15]}, sharex = 'col')
...
fig.savefig(Path(FigConfig.paths['savefig_folder']) / f"{yyyymmdd}_cotAcrossMicePermuted_incline_snoutBodyAngle_ALL.svg", dpi = 300)
